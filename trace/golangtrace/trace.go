...
import (
	...
	"github.com/zxfonline/monitor/trace/golangtrace/timeseries"
)
...
func Render(w io.Writer, req *http.Request, sensitive bool, title string) {
	data := &struct {
		Families         []string
...
func GetAllExpvarFamily(state int) any {
